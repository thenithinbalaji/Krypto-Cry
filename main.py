        ...
        if client.user.mentioned_in(message):
            ...
            if len(word) == 0:
                ...
                if type(data) == list:
                    ...
                    if round(float(usdprice)) > 10:
                        usdprice = str(round(float(usdprice), 3))
                    else:
                        if (
                            round(float(usdprice), 3) == 0.0
                            and round(float(usdprice), 6) != 0.0
                        ):
                            usdprice = str(format(round(float(usdprice), 6), ".6f"))
                        elif (
                            round(float(usdprice), 3) == 0.0
                            and round(float(usdprice), 6) == 0.0
                        ):
                    ...
                    embed.add_field(
                        name="Price", value="$" + str(usdprice), inline=True
                    )
                    ...
                    embed.add_field(
                        name="List of Crypto Prices Available",
